...
(function () {
  document.addEventListener('DOMContentLoaded', function () {
    ...
    /* PayPal no comparte nada del flujo de tarjeta/efectivo: no hay pasarela
       ...
       billing/views.py). Acá solo se muestra el botón dedicado en vez del
       genérico y el aviso de qué va a pasar. */
    ...
    function togglePaypalCampos() {
      ...
      paypalPagarBtn.classList.toggle('d-none-force', !esPaypal);
