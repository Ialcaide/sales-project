...
(function () {
  document.addEventListener('DOMContentLoaded', function () {
    ...
    /* ---------- Tarjeta animada (preview visual + detección de marca) ----------
       ...
       prefijo. Lo único que sí viaja al backend son los últimos 4 dígitos
       (campo real del form, ver InvoiceForm). */
    ...
    var tarjetaUltimosInput = document.getElementById('id_tarjeta_ultimos_digitos');
    ...
    if (ccNumberInput && ccFlipCard) {
      ...
      function updateCard() {
        ...
        if (tarjetaUltimosInput && last4.length === 4) {
          tarjetaUltimosInput.value = last4;
        }
      }
