...
(function () {
  document.addEventListener('DOMContentLoaded', function () {
    ...
    /* Cuando cambia el proveedor: recalcula costo/último precio sugerido de
       ...
       productos quedan disponibles. Select2 propio (no initSelect2(), que
       es específico de las filas de producto y espera un <tr> ancestro —
       el select de proveedor no vive dentro de una tabla). */
    ...
    document.getElementById('quick-supplier-save').addEventListener('click', function () {
      ...
      fetch(data.quickCreateUrl, {
        ...
        .then(function (result) {
          ...
          console.log('DEBUG about to hide modal, className before:', quickSupplierModalEl.className);
          quickSupplierModal.hide();
          console.log('DEBUG hide() called, className right after:', quickSupplierModalEl.className);
          setTimeout(function () {
            console.log('DEBUG className 400ms later:', quickSupplierModalEl.className);
          }, 400);
        })
        .catch(function (err) {
          console.error('DEBUG quick-supplier error:', err);
